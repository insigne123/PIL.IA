                        ...
                        {data.map((row) => {
                            ...
                            return (
                                <TableRow key={row.id} className={cn(
                                    ...
                                    isTitle ? "bg-slate-100/80 hover:bg-slate-200/80" : ""
                                )}>
                                    <TableCell>
                                        {isTitle ? (
                                            <Badge variant="outline" className="bg-slate-200 text-slate-700 border-slate-300 text-[10px] uppercase font-bold tracking-wider">
                                                Sección
                                            </Badge>
                                        ) : row.status === 'approved' ? (
                                    ...
                                    <TableCell className={cn("font-medium text-xs", isTitle && "font-bold text-slate-800 uppercase")}>
                                        {row.excel_item_text}
                                        {(row as any).suggestion && (
                                            <div className="mt-1 flex items-center gap-1 text-[10px] text-amber-600 bg-amber-50 p-1 rounded border border-amber-200">
                                    ...
                                    <TableCell className="text-xs">
                                        {isTitle ? (
                                            <span className="text-slate-400 text-[10px] italic">No requiere match</span>
